...
def division_game_ui(student_name):
    def next_question():
    ...
    tk.Label(root, text=f"Welcome {student_name} to the Division Quiz!", font=("Arial", 14)).pack(pady=10)
